...
const Home = props =>
  <div className="home">
    <div>
      ...
      <input type="text" name="room" placeholder="Type topic here..." onChange={props.handleChange} pattern="^\w+$" maxLength="255" required autoFocus title="Room name should only contain letters or numbers."/>
