...
const Communication = props => (
  <div className="auth">
    ...
    <div className="request-access">
      <p>
        <span className="you-left">You hung up.&nbsp;</span>Send a message and
        ask to join debate
      </p>
    ...
    <div className="grant-access">
      <p>A peer has sent you a message to join the debate:</p>
      <div dangerouslySetInnerHTML={props.getContent(props.message)} />
      <button
    ...
    <div className="room-occupied">
      <p>Room is occupied. Please, try another debate!</p>
